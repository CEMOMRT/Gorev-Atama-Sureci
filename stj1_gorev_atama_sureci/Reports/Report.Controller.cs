...
namespace stj1_gorev_atama_sureci.Report
{
	[EnableCors]
    [DontWrapResultFilter]
    [ApiExplorerSettings(IgnoreApi = true)]
	[Route("apps/stj1_gorev_atama_sureci/latest/api/ReportViewer")]
	[Route("api/ReportViewer")]
	[Route("apps/stj1_gorev_atama_sureci/{v:int:min(1)}/api/ReportViewer")]
