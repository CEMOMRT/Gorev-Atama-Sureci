...
{
    [Route("apps/stj1_gorev_atama_sureci/latest/api/DataSource/[action]")]
    [Route("apps/stj1_gorev_atama_sureci/{v:int:min(1)}/api/DataSource/[action]")]
...
[HttpPost]
[AcceptVerbs("POST")]
[ActionName("astKisiler")]
[NoRequestHeaders]
[NoResponseHeaders]
public async Task<object> astKisiler_Action([FromBody] astKisilerRequest request)
{
    return await astKisiler(request);
}
...
internal async Task<DataSourceResponse<object>> astKisiler(astKisilerRequest request)
{
    string queryContent = "{\n  \"name\": \"astKisiler\",\n  \"connectionId\": \"c914bb72-a9c0-43a9-b1a4-4bf5dfae6f4d\",\n  \"connectionName\": {\n    \"tr-TR\": \"SYNERGY\"\n  },\n  \"connectionType\": 1,\n  \"description\": {},\n  \"id\": null,\n  \"properties\": {\n    \"cacheTTL\": 60000,\n    \"cacheType\": \"Memory\",\n    \"enableCache\": true,\n    \"timeout\": 60,\n    \"commandText\": \"SELECT ID,FIRSTNAME + ' ' + LASTNAME AS 'Ad Soyad'\\r\\nFROM OSUSERS\\r\\nWHERE STATUS=1 AND DEPARTMENT={{DEPID}} AND ID != {{USERID}}\",\n    \"parameters\": [\n      {\n        \"caption\": \"\",\n        \"isActive\": true,\n        \"isRequired\": true,\n        \"key\": \"DEPID\",\n        \"value\": \"%User.Department.Id%\",\n        \"valueType\": 1,\n        \"length\": 255,\n        \"subType\": null\n      },\n      {\n        \"caption\": \"\",\n        \"isActive\": true,\n        \"isRequired\": true,\n        \"key\": \"USERID\",\n        \"value\": \"%User.Id%\",\n        \"valueType\": 1,\n        \"length\": 255,\n        \"subType\": null\n      }\n    ],\n    \"commandType\": 1,\n    \"executionType\": 3\n  },\n  \"structure\": {\n    \"columns\": [\n      {\n        \"name\": \"ID\",\n        \"type\": 3,\n        \"caption\": \"ID\",\n        \"columns\": []\n      },\n      {\n        \"name\": \"Ad Soyad\",\n        \"type\": 1,\n        \"caption\": \"Ad Soyad\",\n        \"columns\": []\n      }\n    ],\n    \"returnType\": 10\n  }\n}";
...
[NonAction] public IEnumerable astKisilerIterator(astKisilerRequest request)
{
            int pagingSkip = 0;
            int pagingTake = 100;
            int pageIndex = 0;
            ...
            while (!endOfSource)
            {
                ...
                var response = astKisiler(request).Result;
                endOfSource = response.IsEndOfSource;
                if (response.Success && response.Result != null)
                {
                    JArray data = (JArray)response.Result;
